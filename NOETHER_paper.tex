...
\begin{table}[h]
\centering
\caption{Mapping of METRIC$+$'s $11$ input-domain $\times$
output-relation category pairs (per~\cite{SunMETRICplus2021}
Table~II) onto NOETHER's eight blocks for a deterministic
comparison-sort library. $9$ pairs collapse onto two non-empty
