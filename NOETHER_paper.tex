...
detected $0/5$. The Fisher exact two-sided $p$-value on this $2\times 2$
is $p = 1.00$ ($n=5$ is below the threshold at which $(2, 0)$ vs $(0, 0)$
discordant counts are inferentially decisive); per-pair statistics in
supplementary~S3 \texttt{deepcrime\_pilot\_stats.json}.}
