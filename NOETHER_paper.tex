...
PIT-covered substrate is $26 + 4 + 15 = 45 / 52 = 86.5\%$,
materially above Set~G alone's $37 / 52 = 71.2\%$ and Set~N alone's
$30 / 52 = 57.7\%$. The complementarity is asymmetric: Set~G's
...
\texttt{f7edfa7}). Mutant evaluation uses \texttt{mvn test} on the
