...
quantitative reading: \emph{approximate per-block detection parity
on $\mathcal{T}^{*}$ ($10/17$ vs $8/17$) and complementarity on
$\mathcal{L}^{*}$ are achieved at $\approx 1$ hour amortised human
generation cost per SUT (NOETHER) versus $\approx 30$ minutes
per-SUT GP search wall time (Set~G), with NOETHER's cost amortising
across new SUTs in the same algebra family while Set~G's restarts
from scratch}. The $G$-block gap on the substrate's two
...
\begin{table}[h]
\centering
\caption{Construct-trace consistency on hand-crafted block-targeted
mutants ($n = 5$ per block, $25$ total). Set~N's near-$100\%$ detection
is design-implied (each mutant constructed against a specific Set~N
MR's targeted invariant); Set~G's $12/25 = 0.480$ measures the
incidental reach of GP-evolved generic MRs on the same mutants.
...
\begin{tabular}{lrrlrlrrrr}
\toprule
Block & $n$ & Set~N kills & rate (95\% CI) & Set~G kills & rate (95\% CI) & both & $N$-only & $G$-only & neither \\
\midrule
$O_{\le}$                                  & 5 & 5 & $1.000$ $[0.566,\,1.000]$ & 3 & $0.600$ $[0.231,\,0.882]$ & 3 & 2 & 0 & 0 \\
$\mathcal{T}^{*}_{\mathrm{rev}}$           & 5 & 5 & $1.000$ $[0.566,\,1.000]$ & 0 & $0.000$ $[0.000,\,0.434]$ & 0 & 5 & 0 & 0 \\
$\mathcal{D}^{*}$                          & 5 & 5 & $1.000$ $[0.566,\,1.000]$ & 4 & $0.800$ $[0.376,\,0.964]$ & 4 & 1 & 0 & 0 \\
$\mathcal{E}^{*}$                          & 5 & 5 & $1.000$ $[0.566,\,1.000]$ & 5 & $1.000$ $[0.566,\,1.000]$ & 5 & 0 & 0 & 0 \\
$\mathcal{B}^{*}_{\mathrm{rel}}$           & 5 & 5 & $1.000$ $[0.566,\,1.000]$ & 0 & $0.000$ $[0.000,\,0.434]$ & 0 & 5 & 0 & 0 \\
\midrule
\textit{aggregate} & 25 & 25 & $1.000$ $[0.867,\,1.000]$ & 12 & $0.480$ $[0.300,\,0.665]$ & 12 & 13 & 0 & 0 \\
\bottomrule
\end{tabular}
\end{table}
