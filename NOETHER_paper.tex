...
(i) METRIC$+$ head-to-head: re-implement category enumeration as automated identifier, run on \S\ref{subsec:test-design}~substrate & $\approx 2$\,weeks engineering & Convert qualitative coverage contrast into measured kill-rate \\
