...
This appendix tabulates the per-block head-to-head complementarity discussed in \S\ref{subsec:pooled-headtohead}, relocated here for main-body length conformance; the per-SUT kill-count table is in supplementary~S9 (\texttt{detailed\_tables}).
