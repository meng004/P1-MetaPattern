...
This appendix tabulates the per-SUT head-to-head kill counts discussed in \S\ref{subsec:pooled-headtohead}, relocated here for main-body length conformance.
