...
%% TOSEM double-anonymous submission (acmsmall + review + anonymous).
%% The anonymous option auto-hides \author/\affiliation/\orcid/\email/\authornote
%% and the \begin{acks} block (funding, CRediT, GenAI disclosure, COI).
...
\acmArticle{0}
\acmMonth{0}
%% arXiv DOI withheld during double-anonymous review (restored at camera-ready).
...
in a public repository whose DOI is withheld here for double-anonymous review
(supplied to the editor, and to reviewers in anonymised form).
...
in a public archival repository whose DOI is withheld here for
double-anonymous review and restored at camera-ready. The
...
double-anonymous review and restored at camera-ready.
