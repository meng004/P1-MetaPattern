...
\acmArticle{0}
\acmMonth{0}
%\acmDOI{}  %% removed for double-anonymous review (arXiv DOI de-anonymises)
...
%% \acmConference removed for double-anonymous TOSEM journal submission
...
Such catalogues are useful, but each is, by construction, an empirical artefact. None of the existing catalogues, including prior reactor-physics catalogues, can answer the three foundational questions of Section~\ref{sec:intro}.
