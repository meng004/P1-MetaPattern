...
/** Auto-generated head-to-head MR class for SUT fm_cos (org.apache.commons.math3.util.FastMath.cos). Blocks: G,Lstar,Ole. */
public class T_fm_cos {
    ...
    @Test public void nN_even() { for (double x : DT) { assertEquals(org.apache.commons.math3.util.FastMath.cos(x), org.apache.commons.math3.util.FastMath.cos(-x), 1e-12+1e-12*Math.abs(org.apache.commons.math3.util.FastMath.cos(x))); } }
    @Test public void nN_period() { for (double x : DT) { assertEquals(org.apache.commons.math3.util.FastMath.cos(x), org.apache.commons.math3.util.FastMath.cos(x+2.0*Math.PI), 1e-9); } }
    @Test public void nN_bound() { for (double x : DT) { double s=org.apache.commons.math3.util.FastMath.cos(x); assertTrue(s<=1.0+1e-12 && s>=-1.0-1e-12); } }
    @Test public void nN_shiftpi() { for (double x : DT) { assertEquals(org.apache.commons.math3.util.FastMath.cos(x), -org.apache.commons.math3.util.FastMath.cos(x+Math.PI), 1e-9); } }
    @Test public void bB_bound() { for (double x : DT) { double s=org.apache.commons.math3.util.FastMath.cos(x); assertTrue(s<=1.0+1e-12 && s>=-1.0-1e-12); } }
    @Test public void mM_sign_inv() { for (double x : DT) { assertEquals(org.apache.commons.math3.util.FastMath.cos(x), org.apache.commons.math3.util.FastMath.cos(-x), 1e-12+1e-12*Math.abs(org.apache.commons.math3.util.FastMath.cos(x))); } }
    @Test public void mM_additive() { for (double x : DT) { assertEquals(org.apache.commons.math3.util.FastMath.cos(x), org.apache.commons.math3.util.FastMath.cos(x+2.0*Math.PI), 1e-9); } }
}