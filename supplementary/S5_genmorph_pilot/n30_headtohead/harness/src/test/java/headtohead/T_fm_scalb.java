...
/** Auto-generated head-to-head MR class for SUT fm_scalb (org.apache.commons.math3.util.FastMath.scalb). Blocks: Lstar,Istar. */
public class T_fm_scalb {
    ...
    @Test public void nN_homom() { for (double x : DS) { if (Double.isNaN(x)||Double.isInfinite(x)) continue; for (int n : new int[]{1,2,3}) assertEquals(org.apache.commons.math3.util.FastMath.scalb(x,n+2), org.apache.commons.math3.util.FastMath.scalb(org.apache.commons.math3.util.FastMath.scalb(x,n),2), 1e-12*Math.abs(org.apache.commons.math3.util.FastMath.scalb(x,n+2))+1e-300); } }
    @Test public void nN_pow2() { for (double x : DS) { if (Double.isNaN(x)||Double.isInfinite(x)||Math.abs(x)>1e150) continue; for (int n : new int[]{0,1,2,3,4}) assertEquals(x*Math.pow(2.0,n), org.apache.commons.math3.util.FastMath.scalb(x,n), 1e-9*Math.abs(x*Math.pow(2.0,n))+1e-300); } }
    @Test public void nN_linear() { for (double x : DS) { if (Double.isNaN(x)||Double.isInfinite(x)) continue; assertEquals(3.0*org.apache.commons.math3.util.FastMath.scalb(x,2), org.apache.commons.math3.util.FastMath.scalb(3.0*x,2), 1e-9*Math.abs(3.0*org.apache.commons.math3.util.FastMath.scalb(x,2))+1e-300); } }
    @Test public void bB_pow2() { for (double x : DS) { if (Double.isNaN(x)||Double.isInfinite(x)||Math.abs(x)>1e150) continue; for (int n : new int[]{0,1,2,3,4}) assertEquals(x*Math.pow(2.0,n), org.apache.commons.math3.util.FastMath.scalb(x,n), 1e-9*Math.abs(x*Math.pow(2.0,n))+1e-300); } }
    @Test public void mM_scale_homog() { for (double x : DS) { if (Double.isNaN(x)||Double.isInfinite(x)) continue; assertEquals(3.0*org.apache.commons.math3.util.FastMath.scalb(x,2), org.apache.commons.math3.util.FastMath.scalb(3.0*x,2), 1e-9*Math.abs(3.0*org.apache.commons.math3.util.FastMath.scalb(x,2))+1e-300); } }
}