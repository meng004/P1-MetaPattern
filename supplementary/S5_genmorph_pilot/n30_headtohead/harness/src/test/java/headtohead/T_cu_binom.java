...
/** Auto-generated head-to-head MR class for SUT cu_binom (org.apache.commons.math3.util.CombinatoricsUtils.binomialCoefficient). Blocks: G,Istar,Ole. */
public class T_cu_binom {
    ...
    @Test public void nN_symmetry() { for (int[] xy : NK) { int n=xy[0],k=xy[1]; if (n>60||k<0||k>n) continue; assertEquals(org.apache.commons.math3.util.CombinatoricsUtils.binomialCoefficient(n,k), org.apache.commons.math3.util.CombinatoricsUtils.binomialCoefficient(n,n-k)); } }
    @Test public void nN_pascal() { for (int[] xy : NK) { int n=xy[0],k=xy[1]; if (n<1||n>60||k<1||k>n-1) continue; assertEquals(org.apache.commons.math3.util.CombinatoricsUtils.binomialCoefficient(n,k), org.apache.commons.math3.util.CombinatoricsUtils.binomialCoefficient(n-1,k-1)+org.apache.commons.math3.util.CombinatoricsUtils.binomialCoefficient(n-1,k)); } }
    @Test public void nN_edge1() { for (int n=0;n<=40;n++){ assertEquals(1L, org.apache.commons.math3.util.CombinatoricsUtils.binomialCoefficient(n,0)); assertEquals(1L, org.apache.commons.math3.util.CombinatoricsUtils.binomialCoefficient(n,n)); } }
    @Test public void bB_symmetry() { for (int[] xy : NK) { int n=xy[0],k=xy[1]; if (n>60||k<0||k>n) continue; assertEquals(org.apache.commons.math3.util.CombinatoricsUtils.binomialCoefficient(n,k), org.apache.commons.math3.util.CombinatoricsUtils.binomialCoefficient(n,n-k)); } }
    @Test public void mM_perm_inv() { for (int[] xy : NK) { int n=xy[0],k=xy[1]; if (n>60||k<0||k>n) continue; assertEquals(org.apache.commons.math3.util.CombinatoricsUtils.binomialCoefficient(n,k), org.apache.commons.math3.util.CombinatoricsUtils.binomialCoefficient(n,n-k)); } }
}