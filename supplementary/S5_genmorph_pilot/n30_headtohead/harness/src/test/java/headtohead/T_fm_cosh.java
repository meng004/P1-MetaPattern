...
/** Auto-generated head-to-head MR class for SUT fm_cosh (org.apache.commons.math3.util.FastMath.cosh). Blocks: G,Lstar,Ole. */
public class T_fm_cosh {
    ...
    @Test public void nN_even() { for (double x : DSH) { assertEquals(org.apache.commons.math3.util.FastMath.cosh(x), org.apache.commons.math3.util.FastMath.cosh(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.cosh(x))); } }
    @Test public void nN_lower() { for (double x : DSH) { assertTrue(org.apache.commons.math3.util.FastMath.cosh(x) >= 1.0 - 1e-12); } }
    @Test public void nN_zero() { assertEquals(1.0, org.apache.commons.math3.util.FastMath.cosh(0.0), 1e-15); }
    @Test public void bB_lower() { for (double x : DSH) { assertTrue(org.apache.commons.math3.util.FastMath.cosh(x) >= 1.0 - 1e-12); } }
    @Test public void mM_sign_inv() { for (double x : DSH) { assertEquals(org.apache.commons.math3.util.FastMath.cosh(x), org.apache.commons.math3.util.FastMath.cosh(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.cosh(x))); } }
}