...
/** Auto-generated head-to-head MR class for SUT fm_sinh (org.apache.commons.math3.util.FastMath.sinh). Blocks: G,Lstar,Ole. */
public class T_fm_sinh {
    ...
    @Test public void nN_odd() { for (double x : DSH) { assertEquals(org.apache.commons.math3.util.FastMath.sinh(x), -org.apache.commons.math3.util.FastMath.sinh(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.sinh(x))); } }
    @Test public void nN_zero() { assertEquals(0.0, org.apache.commons.math3.util.FastMath.sinh(0.0), 1e-15); }
    @Test public void nN_mono() { for (double x : DSH) { assertTrue(org.apache.commons.math3.util.FastMath.sinh(x) <= org.apache.commons.math3.util.FastMath.sinh(x+0.25)); } }
    @Test public void bB_odd() { for (double x : DSH) { assertEquals(org.apache.commons.math3.util.FastMath.sinh(x), -org.apache.commons.math3.util.FastMath.sinh(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.sinh(x))); } }
    @Test public void mM_sign_flip() { for (double x : DSH) { assertEquals(org.apache.commons.math3.util.FastMath.sinh(x), -org.apache.commons.math3.util.FastMath.sinh(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.sinh(x))); } }
}