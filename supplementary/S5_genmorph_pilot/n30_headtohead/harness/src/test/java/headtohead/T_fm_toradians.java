...
/** Auto-generated head-to-head MR class for SUT fm_toradians (org.apache.commons.math3.util.FastMath.toRadians). Blocks: Lstar,Istar. */
public class T_fm_toradians {
    ...
    @Test public void nN_homog() { for (double x : DS) { if (Math.abs(x)>1e6) continue; for (double c : new double[]{2.0,3.0,0.5}) assertEquals(c*org.apache.commons.math3.util.FastMath.toRadians(x), org.apache.commons.math3.util.FastMath.toRadians(c*x), 1e-12+1e-12*Math.abs(c*org.apache.commons.math3.util.FastMath.toRadians(x))); } }
    @Test public void nN_additive() { for (double[] xy : DDs) { double a=xy[0],b=xy[1]; if (Math.abs(a)>1e6||Math.abs(b)>1e6) continue; assertEquals(org.apache.commons.math3.util.FastMath.toRadians(a)+org.apache.commons.math3.util.FastMath.toRadians(b), org.apache.commons.math3.util.FastMath.toRadians(a+b), 1e-12+1e-12*Math.abs(org.apache.commons.math3.util.FastMath.toRadians(a+b))); } }
    @Test public void nN_inverse() { for (double x : DS) { if (Math.abs(x)>1e6) continue; assertEquals(x, org.apache.commons.math3.util.FastMath.toDegrees(org.apache.commons.math3.util.FastMath.toRadians(x)), 1e-9+1e-12*Math.abs(x)); } }
    @Test public void bB_inverse() { for (double x : DS) { if (Math.abs(x)>1e6) continue; assertEquals(x, org.apache.commons.math3.util.FastMath.toDegrees(org.apache.commons.math3.util.FastMath.toRadians(x)), 1e-9+1e-12*Math.abs(x)); } }
    @Test public void mM_scale_homog() { for (double x : DS) { if (Math.abs(x)>1e6) continue; for (double c : new double[]{2.0,3.0,0.5}) assertEquals(c*org.apache.commons.math3.util.FastMath.toRadians(x), org.apache.commons.math3.util.FastMath.toRadians(c*x), 1e-12+1e-12*Math.abs(c*org.apache.commons.math3.util.FastMath.toRadians(x))); } }
    @Test public void mM_additive() { for (double[] xy : DDs) { double a=xy[0],b=xy[1]; if (Math.abs(a)>1e6||Math.abs(b)>1e6) continue; assertEquals(org.apache.commons.math3.util.FastMath.toRadians(a)+org.apache.commons.math3.util.FastMath.toRadians(b), org.apache.commons.math3.util.FastMath.toRadians(a+b), 1e-12+1e-12*Math.abs(org.apache.commons.math3.util.FastMath.toRadians(a+b))); } }
}