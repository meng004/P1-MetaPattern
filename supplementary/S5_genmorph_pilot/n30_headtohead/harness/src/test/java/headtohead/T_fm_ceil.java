...
/** Auto-generated head-to-head MR class for SUT fm_ceil (org.apache.commons.math3.util.FastMath.ceil). Blocks: Tstar,Istar,Ole. */
public class T_fm_ceil {
    ...
    @Test public void nN_intshift() { for (double x : DSF) { for (int k : new int[]{1,2,-3}) assertEquals(org.apache.commons.math3.util.FastMath.ceil(x)+k, org.apache.commons.math3.util.FastMath.ceil(x+k), 0.0); } }
    @Test public void nN_idem() { for (double x : DSF) { assertEquals(org.apache.commons.math3.util.FastMath.ceil(x), org.apache.commons.math3.util.FastMath.ceil(org.apache.commons.math3.util.FastMath.ceil(x)), 0.0); } }
    @Test public void nN_ge() { for (double x : DSF) { if (Double.isInfinite(x)||Double.isNaN(x)) continue; assertTrue(org.apache.commons.math3.util.FastMath.ceil(x) >= x); } }
    @Test public void nN_reflect() { for (double x : DSF) { if (Double.isInfinite(x)||Double.isNaN(x)) continue; assertEquals(org.apache.commons.math3.util.FastMath.ceil(x), -org.apache.commons.math3.util.FastMath.floor(-x), 0.0); } }
    @Test public void bB_ge() { for (double x : DSF) { if (Double.isInfinite(x)||Double.isNaN(x)) continue; assertTrue(org.apache.commons.math3.util.FastMath.ceil(x) >= x); } }
    @Test public void mM_additive() { for (double x : DSF) { for (int k : new int[]{1,2,-3}) assertEquals(org.apache.commons.math3.util.FastMath.ceil(x)+k, org.apache.commons.math3.util.FastMath.ceil(x+k), 0.0); } }
}