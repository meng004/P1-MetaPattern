...
/** Auto-generated head-to-head MR class for SUT fm_tanh (org.apache.commons.math3.util.FastMath.tanh). Blocks: G,Lstar,Ole. */
public class T_fm_tanh {
    ...
    @Test public void nN_odd() { for (double x : DSH) { assertEquals(org.apache.commons.math3.util.FastMath.tanh(x), -org.apache.commons.math3.util.FastMath.tanh(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.tanh(x))); } }
    @Test public void nN_bound() { for (double x : DSH) { double t=org.apache.commons.math3.util.FastMath.tanh(x); assertTrue(t<1.0+1e-12 && t>-1.0-1e-12); } }
    @Test public void nN_mono() { for (double x : DSH) { assertTrue(org.apache.commons.math3.util.FastMath.tanh(x) <= org.apache.commons.math3.util.FastMath.tanh(x+0.25)+1e-12); } }
    @Test public void bB_bound() { for (double x : DSH) { double t=org.apache.commons.math3.util.FastMath.tanh(x); assertTrue(t<1.0+1e-12 && t>-1.0-1e-12); } }
    @Test public void mM_sign_flip() { for (double x : DSH) { assertEquals(org.apache.commons.math3.util.FastMath.tanh(x), -org.apache.commons.math3.util.FastMath.tanh(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.tanh(x))); } }
}