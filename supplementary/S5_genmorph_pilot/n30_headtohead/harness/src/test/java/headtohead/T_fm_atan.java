...
/** Auto-generated head-to-head MR class for SUT fm_atan (org.apache.commons.math3.util.FastMath.atan). Blocks: G,Lstar,Ole. */
public class T_fm_atan {
    ...
    @Test public void nN_odd() { for (double x : DS) { if (Double.isNaN(x)) continue; assertEquals(org.apache.commons.math3.util.FastMath.atan(x), -org.apache.commons.math3.util.FastMath.atan(-x), 1e-12+1e-12*Math.abs(org.apache.commons.math3.util.FastMath.atan(x))); } }
    @Test public void nN_bound() { for (double x : DS) { if (Double.isNaN(x)) continue; double a=org.apache.commons.math3.util.FastMath.atan(x); assertTrue(a<Math.PI/2+1e-12 && a>-Math.PI/2-1e-12); } }
    @Test public void nN_mono() { for (double x : DS) { if (Double.isNaN(x)||Double.isInfinite(x)) continue; assertTrue(org.apache.commons.math3.util.FastMath.atan(x) <= org.apache.commons.math3.util.FastMath.atan(x+1.0)+1e-12); } }
    @Test public void bB_bound() { for (double x : DS) { if (Double.isNaN(x)) continue; double a=org.apache.commons.math3.util.FastMath.atan(x); assertTrue(a<Math.PI/2+1e-12 && a>-Math.PI/2-1e-12); } }
    @Test public void mM_sign_flip() { for (double x : DS) { if (Double.isNaN(x)) continue; assertEquals(org.apache.commons.math3.util.FastMath.atan(x), -org.apache.commons.math3.util.FastMath.atan(-x), 1e-12+1e-12*Math.abs(org.apache.commons.math3.util.FastMath.atan(x))); } }
}