...
/** Auto-generated head-to-head MR class for SUT fm_abs_d (org.apache.commons.math3.util.FastMath.abs). Blocks: Lstar,Istar. */
public class T_fm_abs_d {
    ...
    @Test public void nN_even() { for (double x : DS) { assertEquals(org.apache.commons.math3.util.FastMath.abs(x), org.apache.commons.math3.util.FastMath.abs(-x), 0.0); } }
    @Test public void nN_idem() { for (double x : DS) { assertEquals(org.apache.commons.math3.util.FastMath.abs(x), org.apache.commons.math3.util.FastMath.abs(org.apache.commons.math3.util.FastMath.abs(x)), 0.0); } }
    @Test public void nN_nonneg() { for (double x : DS) { if (Double.isNaN(x)) continue; assertTrue(org.apache.commons.math3.util.FastMath.abs(x) >= 0.0); } }
    @Test public void nN_homog() { for (double x : DS) { for (double c : new double[]{2.0,3.0,0.5}) assertEquals(c*org.apache.commons.math3.util.FastMath.abs(x), org.apache.commons.math3.util.FastMath.abs(c*x), 1e-9+1e-9*c*org.apache.commons.math3.util.FastMath.abs(x)); } }
    @Test public void bB_nonneg() { for (double x : DS) { if (Double.isNaN(x)) continue; assertTrue(org.apache.commons.math3.util.FastMath.abs(x) >= 0.0); } }
    @Test public void mM_sign_inv() { for (double x : DS) { assertEquals(org.apache.commons.math3.util.FastMath.abs(x), org.apache.commons.math3.util.FastMath.abs(-x), 0.0); } }
    @Test public void mM_scale_homog() { for (double x : DS) { for (double c : new double[]{2.0,3.0,0.5}) assertEquals(c*org.apache.commons.math3.util.FastMath.abs(x), org.apache.commons.math3.util.FastMath.abs(c*x), 1e-9+1e-9*c*org.apache.commons.math3.util.FastMath.abs(x)); } }
}