...
/** Auto-generated head-to-head MR class for SUT fm_signum_d (org.apache.commons.math3.util.FastMath.signum). Blocks: G,Lstar. */
public class T_fm_signum_d {
    ...
    @Test public void nN_odd() { for (double x : DS) { if (x==0.0) continue; assertEquals(org.apache.commons.math3.util.FastMath.signum(x), -org.apache.commons.math3.util.FastMath.signum(-x), 0.0); } }
    @Test public void nN_posscale() { for (double x : DS) { for (double c : new double[]{2.0,0.5,10.0}) assertEquals(org.apache.commons.math3.util.FastMath.signum(x), org.apache.commons.math3.util.FastMath.signum(c*x), 0.0); } }
    @Test public void nN_range() { for (double x : DS) { double s=org.apache.commons.math3.util.FastMath.signum(x); assertTrue(s==-1.0||s==0.0||s==1.0||Double.isNaN(s)); } }
    @Test public void bB_range() { for (double x : DS) { double s=org.apache.commons.math3.util.FastMath.signum(x); assertTrue(s==-1.0||s==0.0||s==1.0||Double.isNaN(s)); } }
    @Test public void mM_sign_flip() { for (double x : DS) { if (x==0.0) continue; assertEquals(org.apache.commons.math3.util.FastMath.signum(x), -org.apache.commons.math3.util.FastMath.signum(-x), 0.0); } }
    @Test public void mM_scale_homog() { for (double x : DS) { for (double c : new double[]{2.0,0.5,10.0}) assertEquals(org.apache.commons.math3.util.FastMath.signum(x), org.apache.commons.math3.util.FastMath.signum(c*x), 0.0); } }
}