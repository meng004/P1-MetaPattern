...
/** Auto-generated head-to-head MR class for SUT fm_log1p (org.apache.commons.math3.util.FastMath.log1p). Blocks: Lstar,Ole. */
public class T_fm_log1p {
    ...
    @Test public void nN_zero() { assertEquals(0.0, org.apache.commons.math3.util.FastMath.log1p(0.0), 1e-15); }
    @Test public void nN_mono() { for (double x : DSP) { assertTrue(org.apache.commons.math3.util.FastMath.log1p(x) <= org.apache.commons.math3.util.FastMath.log1p(x+0.5)); } }
    @Test public void nN_consistency() { for (double x : DSP) { assertEquals(org.apache.commons.math3.util.FastMath.log(1.0+x), org.apache.commons.math3.util.FastMath.log1p(x), 1e-9*Math.abs(org.apache.commons.math3.util.FastMath.log1p(x))+1e-12); } }
    @Test public void bB_zero() { assertEquals(0.0, org.apache.commons.math3.util.FastMath.log1p(0.0), 1e-15); }
    @Test public void mM_additive() { for (double x : DSP) { assertEquals(org.apache.commons.math3.util.FastMath.log(1.0+x), org.apache.commons.math3.util.FastMath.log1p(x), 1e-9*Math.abs(org.apache.commons.math3.util.FastMath.log1p(x))+1e-12); } }
}