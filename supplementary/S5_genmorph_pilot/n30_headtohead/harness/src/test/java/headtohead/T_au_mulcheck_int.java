...
/** Auto-generated head-to-head MR class for SUT au_mulcheck_int (org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck). Blocks: G,Lstar,Istar. */
public class T_au_mulcheck_int {
    ...
    @Test public void nN_commute() { for (int[] xy : IIs) { int p=xy[0],q=xy[1]; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck(p,q), org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck(q,p)); } }
    @Test public void nN_identity() { for (int[] xy : IIs) { int p=xy[0]; assertEquals(p, org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck(p,1)); assertEquals(0, org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck(p,0)); } }
    @Test public void nN_sign() { for (int[] xy : IIs) { int p=xy[0],q=xy[1]; if (p==Integer.MIN_VALUE||q==Integer.MIN_VALUE) continue; if ((long)Math.abs((long)p)*Math.abs((long)q) > Integer.MAX_VALUE) continue; assertEquals(-org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck(p,q), org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck(-p,q)); } }
    @Test public void bB_commute() { for (int[] xy : IIs) { int p=xy[0],q=xy[1]; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck(p,q), org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck(q,p)); } }
    @Test public void mM_perm_inv() { for (int[] xy : IIs) { int p=xy[0],q=xy[1]; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck(p,q), org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck(q,p)); } }
    @Test public void mM_sign_flip() { for (int[] xy : IIs) { int p=xy[0],q=xy[1]; if (p==Integer.MIN_VALUE||q==Integer.MIN_VALUE) continue; if ((long)Math.abs((long)p)*Math.abs((long)q) > Integer.MAX_VALUE) continue; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck(p,q), -org.apache.commons.math3.util.ArithmeticUtils.mulAndCheck(-p,q)); } }
}