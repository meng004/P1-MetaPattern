...
/** Auto-generated head-to-head MR class for SUT fm_log (org.apache.commons.math3.util.FastMath.log). Blocks: Lstar,Ole. */
public class T_fm_log {
    ...
    @Test public void nN_mullog() { for (double[] xy : DDP) { double a=xy[0],b=xy[1]; if (a<=0||b<=0) continue; double lhs=org.apache.commons.math3.util.FastMath.log(a*b), rhs=org.apache.commons.math3.util.FastMath.log(a)+org.apache.commons.math3.util.FastMath.log(b); assertEquals(rhs, lhs, 1e-9*Math.abs(rhs)+1e-12); } }
    @Test public void nN_one() { assertEquals(0.0, org.apache.commons.math3.util.FastMath.log(1.0), 1e-15); }
    @Test public void nN_mono() { for (double[] xy : DDP) { double a=xy[0]; if (a<=0) continue; assertTrue(org.apache.commons.math3.util.FastMath.log(a) <= org.apache.commons.math3.util.FastMath.log(a*1.5)); } }
    @Test public void nN_powk() { for (double[] xy : DDP) { double a=xy[0]; if (a<=0) continue; assertEquals(3.0*org.apache.commons.math3.util.FastMath.log(a), org.apache.commons.math3.util.FastMath.log(a*a*a), 1e-9*Math.abs(3.0*org.apache.commons.math3.util.FastMath.log(a))+1e-12); } }
    @Test public void bB_one() { assertEquals(0.0, org.apache.commons.math3.util.FastMath.log(1.0), 1e-15); }
    @Test public void mM_scale_homog() { for (double[] xy : DDP) { double a=xy[0],b=xy[1]; if (a<=0||b<=0) continue; double lhs=org.apache.commons.math3.util.FastMath.log(a*b), rhs=org.apache.commons.math3.util.FastMath.log(a)+org.apache.commons.math3.util.FastMath.log(b); assertEquals(rhs, lhs, 1e-9*Math.abs(rhs)+1e-12); } }
}