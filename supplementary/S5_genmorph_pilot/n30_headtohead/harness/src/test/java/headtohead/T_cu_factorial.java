...
/** Auto-generated head-to-head MR class for SUT cu_factorial (org.apache.commons.math3.util.CombinatoricsUtils.factorial). Blocks: Lstar,Istar,Ole. */
public class T_cu_factorial {
    ...
    @Test public void nN_recur() { for (int n=1;n<=20;n++){ assertEquals(org.apache.commons.math3.util.CombinatoricsUtils.factorial(n), (long)n*org.apache.commons.math3.util.CombinatoricsUtils.factorial(n-1)); } }
    @Test public void nN_base() { assertEquals(1L, org.apache.commons.math3.util.CombinatoricsUtils.factorial(0)); assertEquals(1L, org.apache.commons.math3.util.CombinatoricsUtils.factorial(1)); }
    @Test public void nN_mono() { for (int n=1;n<=20;n++){ assertTrue(org.apache.commons.math3.util.CombinatoricsUtils.factorial(n) >= org.apache.commons.math3.util.CombinatoricsUtils.factorial(n-1)); } }
    @Test public void bB_base() { assertEquals(1L, org.apache.commons.math3.util.CombinatoricsUtils.factorial(0)); }
    @Test public void mM_scale_homog() { for (int n=1;n<=20;n++){ assertEquals(org.apache.commons.math3.util.CombinatoricsUtils.factorial(n), (long)n*org.apache.commons.math3.util.CombinatoricsUtils.factorial(n-1)); } }
}