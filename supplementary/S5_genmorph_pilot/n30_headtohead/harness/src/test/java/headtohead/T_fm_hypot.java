...
/** Auto-generated head-to-head MR class for SUT fm_hypot (org.apache.commons.math3.util.FastMath.hypot). Blocks: G,Lstar,Istar. */
public class T_fm_hypot {
    ...
    @Test public void nN_perm() { for (double[] xy : DD) { assertEquals(org.apache.commons.math3.util.FastMath.hypot(xy[0],xy[1]), org.apache.commons.math3.util.FastMath.hypot(xy[1],xy[0]), 1e-12); } }
    @Test public void nN_homog() { for (double[] xy : DD) { double a=xy[0],b=xy[1]; for (double c : new double[]{2.0,0.5,3.0}) {double lhs=org.apache.commons.math3.util.FastMath.hypot(c*a,c*b), rhs=Math.abs(c)*org.apache.commons.math3.util.FastMath.hypot(a,b); assertEquals(rhs, lhs, 1e-9 + 1e-9*Math.abs(rhs)); } } }
    @Test public void nN_sign() { for (double[] xy : DD) { assertEquals(org.apache.commons.math3.util.FastMath.hypot(xy[0],xy[1]), org.apache.commons.math3.util.FastMath.hypot(-xy[0],xy[1]), 1e-12); } }
    @Test public void nN_lower() { for (double[] xy : DD) { double h=org.apache.commons.math3.util.FastMath.hypot(xy[0],xy[1]); assertTrue(h >= Math.abs(xy[0]) - 1e-9); } }
    @Test public void bB_perm() { for (double[] xy : DD) { assertEquals(org.apache.commons.math3.util.FastMath.hypot(xy[0],xy[1]), org.apache.commons.math3.util.FastMath.hypot(xy[1],xy[0]), 1e-12); } }
    @Test public void mM_perm_inv() { for (double[] xy : DD) { assertEquals(org.apache.commons.math3.util.FastMath.hypot(xy[0],xy[1]), org.apache.commons.math3.util.FastMath.hypot(xy[1],xy[0]), 1e-12); } }
    @Test public void mM_scale_homog() { for (double[] xy : DD) { double a=xy[0],b=xy[1]; for (double c : new double[]{2.0,0.5,3.0}) {double lhs=org.apache.commons.math3.util.FastMath.hypot(c*a,c*b), rhs=Math.abs(c)*org.apache.commons.math3.util.FastMath.hypot(a,b); assertEquals(rhs, lhs, 1e-9 + 1e-9*Math.abs(rhs)); } } }
    @Test public void mM_sign_inv() { for (double[] xy : DD) { assertEquals(org.apache.commons.math3.util.FastMath.hypot(xy[0],xy[1]), org.apache.commons.math3.util.FastMath.hypot(-xy[0],-xy[1]), 1e-12); } }
}