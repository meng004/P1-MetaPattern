...
/** Auto-generated head-to-head MR class for SUT fm_cbrt (org.apache.commons.math3.util.FastMath.cbrt). Blocks: G,Lstar,Ole. */
public class T_fm_cbrt {
    ...
    @Test public void nN_odd() { for (double x : DS) { assertEquals(org.apache.commons.math3.util.FastMath.cbrt(x), -org.apache.commons.math3.util.FastMath.cbrt(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.cbrt(x))); } }
    @Test public void nN_cube() { for (double x : DS) { if (Math.abs(x)>1000) continue; assertEquals(x, org.apache.commons.math3.util.FastMath.cbrt(x*x*x), 1e-6+1e-9*Math.abs(x)); } }
    @Test public void nN_mono() { for (double x : DS) { if (Double.isNaN(x)) continue; assertTrue(org.apache.commons.math3.util.FastMath.cbrt(x) <= org.apache.commons.math3.util.FastMath.cbrt(x+1.0)+1e-12); } }
    @Test public void bB_odd() { for (double x : DS) { assertEquals(org.apache.commons.math3.util.FastMath.cbrt(x), -org.apache.commons.math3.util.FastMath.cbrt(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.cbrt(x))); } }
    @Test public void mM_sign_flip() { for (double x : DS) { assertEquals(org.apache.commons.math3.util.FastMath.cbrt(x), -org.apache.commons.math3.util.FastMath.cbrt(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.cbrt(x))); } }
}