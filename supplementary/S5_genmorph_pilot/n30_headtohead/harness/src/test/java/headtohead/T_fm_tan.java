...
/** Auto-generated head-to-head MR class for SUT fm_tan (org.apache.commons.math3.util.FastMath.tan). Blocks: G,Lstar,Ole. */
public class T_fm_tan {
    ...
    @Test public void nN_odd() { for (double x : DTt) { assertEquals(org.apache.commons.math3.util.FastMath.tan(x), -org.apache.commons.math3.util.FastMath.tan(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.tan(x))); } }
    @Test public void nN_period() { for (double x : DTt) { assertEquals(org.apache.commons.math3.util.FastMath.tan(x), org.apache.commons.math3.util.FastMath.tan(x+Math.PI), 1e-7+1e-7*Math.abs(org.apache.commons.math3.util.FastMath.tan(x))); } }
    @Test public void nN_quotient() { for (double x : DTt) { double c=org.apache.commons.math3.util.FastMath.cos(x); if (Math.abs(c)<1e-3) continue; assertEquals(org.apache.commons.math3.util.FastMath.sin(x)/c, org.apache.commons.math3.util.FastMath.tan(x), 1e-7+1e-7*Math.abs(org.apache.commons.math3.util.FastMath.tan(x))); } }
    @Test public void bB_odd() { for (double x : DTt) { assertEquals(org.apache.commons.math3.util.FastMath.tan(x), -org.apache.commons.math3.util.FastMath.tan(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.tan(x))); } }
    @Test public void mM_sign_flip() { for (double x : DTt) { assertEquals(org.apache.commons.math3.util.FastMath.tan(x), -org.apache.commons.math3.util.FastMath.tan(-x), 1e-9+1e-9*Math.abs(org.apache.commons.math3.util.FastMath.tan(x))); } }
}