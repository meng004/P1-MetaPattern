...
/** Auto-generated head-to-head MR class for SUT fm_todegrees (org.apache.commons.math3.util.FastMath.toDegrees). Blocks: Lstar,Istar. */
public class T_fm_todegrees {
    ...
    @Test public void nN_homog() { for (double x : DS) { if (Math.abs(x)>1e6) continue; for (double c : new double[]{2.0,3.0,0.5}) assertEquals(c*org.apache.commons.math3.util.FastMath.toDegrees(x), org.apache.commons.math3.util.FastMath.toDegrees(c*x), 1e-12+1e-12*Math.abs(c*org.apache.commons.math3.util.FastMath.toDegrees(x))); } }
    @Test public void nN_additive() { for (double[] xy : DDs) { double a=xy[0],b=xy[1]; if (Math.abs(a)>1e6||Math.abs(b)>1e6) continue; assertEquals(org.apache.commons.math3.util.FastMath.toDegrees(a)+org.apache.commons.math3.util.FastMath.toDegrees(b), org.apache.commons.math3.util.FastMath.toDegrees(a+b), 1e-9+1e-12*Math.abs(org.apache.commons.math3.util.FastMath.toDegrees(a+b))); } }
    @Test public void nN_inverse() { for (double x : DS) { if (Math.abs(x)>1e6) continue; assertEquals(x, org.apache.commons.math3.util.FastMath.toRadians(org.apache.commons.math3.util.FastMath.toDegrees(x)), 1e-9+1e-12*Math.abs(x)); } }
    @Test public void bB_inverse() { for (double x : DS) { if (Math.abs(x)>1e6) continue; assertEquals(x, org.apache.commons.math3.util.FastMath.toRadians(org.apache.commons.math3.util.FastMath.toDegrees(x)), 1e-9+1e-12*Math.abs(x)); } }
    @Test public void mM_scale_homog() { for (double x : DS) { if (Math.abs(x)>1e6) continue; for (double c : new double[]{2.0,3.0,0.5}) assertEquals(c*org.apache.commons.math3.util.FastMath.toDegrees(x), org.apache.commons.math3.util.FastMath.toDegrees(c*x), 1e-12+1e-12*Math.abs(c*org.apache.commons.math3.util.FastMath.toDegrees(x))); } }
    @Test public void mM_additive() { for (double[] xy : DDs) { double a=xy[0],b=xy[1]; if (Math.abs(a)>1e6||Math.abs(b)>1e6) continue; assertEquals(org.apache.commons.math3.util.FastMath.toDegrees(a)+org.apache.commons.math3.util.FastMath.toDegrees(b), org.apache.commons.math3.util.FastMath.toDegrees(a+b), 1e-9+1e-12*Math.abs(org.apache.commons.math3.util.FastMath.toDegrees(a+b))); } }
}