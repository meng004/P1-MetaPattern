...
/** Auto-generated head-to-head MR class for SUT au_stirling (org.apache.commons.math3.util.ArithmeticUtils.stirlingS2). Blocks: Istar,Ole. */
public class T_au_stirling {
    ...
    @Test public void nN_edge_nn() { for (int n=1;n<=18;n++){ assertEquals(1L, org.apache.commons.math3.util.ArithmeticUtils.stirlingS2(n,n)); } }
    @Test public void nN_edge_n1() { for (int n=1;n<=18;n++){ assertEquals(1L, org.apache.commons.math3.util.ArithmeticUtils.stirlingS2(n,1)); } }
    @Test public void nN_recur() { for (int[] xy : NK) { int n=xy[0],k=xy[1]; if (n<2||n>18||k<2||k>n-1) continue; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.stirlingS2(n,k), (long)k*org.apache.commons.math3.util.ArithmeticUtils.stirlingS2(n-1,k)+org.apache.commons.math3.util.ArithmeticUtils.stirlingS2(n-1,k-1)); } }
    @Test public void bB_edge_nn() { for (int n=1;n<=18;n++){ assertEquals(1L, org.apache.commons.math3.util.ArithmeticUtils.stirlingS2(n,n)); } }
    @Test public void mM_perm_inv() { for (int n=1;n<=18;n++){ assertEquals(1L, org.apache.commons.math3.util.ArithmeticUtils.stirlingS2(n,1)); } }
}