...
/** Auto-generated head-to-head MR class for SUT au_gcd_int (org.apache.commons.math3.util.ArithmeticUtils.gcd). Blocks: G,Lstar,Ole,Istar. */
public class T_au_gcd_int {
    ...
    @Test public void nN_perm() { for (int[] xy : II) { assertEquals(org.apache.commons.math3.util.ArithmeticUtils.gcd(xy[0],xy[1]), org.apache.commons.math3.util.ArithmeticUtils.gcd(xy[1],xy[0])); } }
    @Test public void nN_scale() { for (int[] xy : II) { int p=xy[0],q=xy[1]; if (Math.abs(p)>1000||Math.abs(q)>1000) continue; for (int k : new int[]{2,3,5}) assertEquals((long)k*org.apache.commons.math3.util.ArithmeticUtils.gcd(p,q),(long)org.apache.commons.math3.util.ArithmeticUtils.gcd(k*p,k*q)); } }
    @Test public void nN_mono() { for (int[] xy : II) { int p=xy[0],q=xy[1]; if (p==0||q==0) continue; if (p==Integer.MIN_VALUE||q==Integer.MIN_VALUE) continue; int g=org.apache.commons.math3.util.ArithmeticUtils.gcd(p,q); assertTrue(g<=Math.abs((long)p) && g<=Math.abs((long)q)); } }
    @Test public void nN_eqref() { for (int[] xy : II) { int p=xy[0],q=xy[1]; if (p==0||Math.abs(p)>1000) continue; for (int k : new int[]{1,2,-1}) { long s=(long)q+(long)k*(long)p; if (s>Integer.MAX_VALUE||s<Integer.MIN_VALUE) continue; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.gcd(p,q), org.apache.commons.math3.util.ArithmeticUtils.gcd(p,(int)s)); } } }
    @Test public void bB_perm() { for (int[] xy : II) { assertEquals(org.apache.commons.math3.util.ArithmeticUtils.gcd(xy[0],xy[1]), org.apache.commons.math3.util.ArithmeticUtils.gcd(xy[1],xy[0])); } }
    @Test public void mM_perm_inv() { for (int[] xy : II) { assertEquals(org.apache.commons.math3.util.ArithmeticUtils.gcd(xy[0],xy[1]), org.apache.commons.math3.util.ArithmeticUtils.gcd(xy[1],xy[0])); } }
    @Test public void mM_sign_inv() { for (int[] xy : II) { int p=xy[0],q=xy[1]; if (p==Integer.MIN_VALUE||q==Integer.MIN_VALUE) continue; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.gcd(p,q), org.apache.commons.math3.util.ArithmeticUtils.gcd(-p,-q)); assertEquals(org.apache.commons.math3.util.ArithmeticUtils.gcd(p,q), org.apache.commons.math3.util.ArithmeticUtils.gcd(-p,q)); } }
}