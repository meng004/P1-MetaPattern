...
/** Auto-generated head-to-head MR class for SUT fm_pow_di (org.apache.commons.math3.util.FastMath.pow). Blocks: Lstar,Istar. */
public class T_fm_pow_di {
    ...
    @Test public void nN_expsum() { for (double[] xy : DDP) { double a=xy[0]; if (a<=0||a>50) continue; for (int e : new int[]{1,2,3}) assertEquals(org.apache.commons.math3.util.FastMath.pow(a,e+1), org.apache.commons.math3.util.FastMath.pow(a,e)*a, 1e-9*Math.abs(org.apache.commons.math3.util.FastMath.pow(a,e+1))+1e-12); } }
    @Test public void nN_exp0() { for (double[] xy : DDP) { double a=xy[0]; assertEquals(1.0, org.apache.commons.math3.util.FastMath.pow(a,0), 0.0); } }
    @Test public void nN_prodbase() { for (double[] xy : DDP) { double a=xy[0]; if (a<=0||a>50) continue; for (int e : new int[]{2,3}) assertEquals(org.apache.commons.math3.util.FastMath.pow(a,e)*org.apache.commons.math3.util.FastMath.pow(2.0,e), org.apache.commons.math3.util.FastMath.pow(a*2.0,e), 1e-9*Math.abs(org.apache.commons.math3.util.FastMath.pow(a*2.0,e))+1e-12); } }
    @Test public void bB_exp0() { for (double[] xy : DDP) { double a=xy[0]; assertEquals(1.0, org.apache.commons.math3.util.FastMath.pow(a,0), 0.0); } }
    @Test public void mM_scale_homog() { for (double[] xy : DDP) { double a=xy[0]; if (a<=0||a>50) continue; for (int e : new int[]{2,3}) assertEquals(org.apache.commons.math3.util.FastMath.pow(a,e)*org.apache.commons.math3.util.FastMath.pow(2.0,e), org.apache.commons.math3.util.FastMath.pow(a*2.0,e), 1e-9*Math.abs(org.apache.commons.math3.util.FastMath.pow(a*2.0,e))+1e-12); } }
}