...
/** Auto-generated head-to-head MR class for SUT au_lcm_int (org.apache.commons.math3.util.ArithmeticUtils.lcm). Blocks: G,Lstar,Istar. */
public class T_au_lcm_int {
    ...
    @Test public void nN_perm() { for (int[] xy : II) { int p=xy[0],q=xy[1]; if (p==0||q==0) {assertEquals(0,org.apache.commons.math3.util.ArithmeticUtils.lcm(p,q)); continue;} if (Math.abs(p)>30000||Math.abs(q)>30000) continue; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.lcm(p,q), org.apache.commons.math3.util.ArithmeticUtils.lcm(q,p)); } }
    @Test public void nN_sign() { for (int[] xy : II) { int p=xy[0],q=xy[1]; if (Math.abs(p)>30000||Math.abs(q)>30000) continue; if (p==Integer.MIN_VALUE||q==Integer.MIN_VALUE) continue; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.lcm(p,q), org.apache.commons.math3.util.ArithmeticUtils.lcm(-p,q)); } }
    @Test public void nN_gcdlcm() { for (int[] xy : II) { int p=xy[0],q=xy[1]; if (p==0||q==0) continue; if (Math.abs(p)>3000||Math.abs(q)>3000) continue; long prod=Math.abs((long)p*(long)q); assertEquals(prod, (long)org.apache.commons.math3.util.ArithmeticUtils.gcd(p,q)*(long)org.apache.commons.math3.util.ArithmeticUtils.lcm(p,q)); } }
    @Test public void bB_perm() { for (int[] xy : II) { int p=xy[0],q=xy[1]; if (p==0||q==0) {assertEquals(0,org.apache.commons.math3.util.ArithmeticUtils.lcm(p,q)); continue;} if (Math.abs(p)>30000||Math.abs(q)>30000) continue; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.lcm(p,q), org.apache.commons.math3.util.ArithmeticUtils.lcm(q,p)); } }
    @Test public void mM_perm_inv() { for (int[] xy : II) { int p=xy[0],q=xy[1]; if (p==0||q==0) continue; if (Math.abs(p)>30000||Math.abs(q)>30000) continue; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.lcm(p,q), org.apache.commons.math3.util.ArithmeticUtils.lcm(q,p)); } }
    @Test public void mM_sign_inv() { for (int[] xy : II) { int p=xy[0],q=xy[1]; if (Math.abs(p)>30000||Math.abs(q)>30000) continue; if (p==Integer.MIN_VALUE||q==Integer.MIN_VALUE) continue; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.lcm(p,q), org.apache.commons.math3.util.ArithmeticUtils.lcm(p,-q)); } }
}