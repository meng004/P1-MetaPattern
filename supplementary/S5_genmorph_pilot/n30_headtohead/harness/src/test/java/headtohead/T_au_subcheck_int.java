...
/** Auto-generated head-to-head MR class for SUT au_subcheck_int (org.apache.commons.math3.util.ArithmeticUtils.subAndCheck). Blocks: G,Tstar,Istar. */
public class T_au_subcheck_int {
    ...
    @Test public void nN_antisym() { for (int[] xy : IIs) { int p=xy[0],q=xy[1]; long fwd=(long)org.apache.commons.math3.util.ArithmeticUtils.subAndCheck(p,q); long bwd; try { bwd=(long)org.apache.commons.math3.util.ArithmeticUtils.subAndCheck(q,p);} catch(Exception e){continue;} assertEquals(fwd, -bwd); } }
    @Test public void nN_identity() { for (int[] xy : IIs) { int p=xy[0]; assertEquals(p, org.apache.commons.math3.util.ArithmeticUtils.subAndCheck(p,0)); assertEquals(0, org.apache.commons.math3.util.ArithmeticUtils.subAndCheck(p,p)); } }
    @Test public void nN_shift() { for (int[] xy : IIs) { int p=xy[0],q=xy[1]; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.subAndCheck(p,q), org.apache.commons.math3.util.ArithmeticUtils.subAndCheck(p+4,q+4)); } }
    @Test public void bB_identity() { for (int[] xy : IIs) { int p=xy[0]; assertEquals(0, org.apache.commons.math3.util.ArithmeticUtils.subAndCheck(p,p)); } }
    @Test public void mM_additive() { for (int[] xy : IIs) { int p=xy[0],q=xy[1]; assertEquals(org.apache.commons.math3.util.ArithmeticUtils.subAndCheck(p,q), org.apache.commons.math3.util.ArithmeticUtils.subAndCheck(p+4,q+4)); } }
    @Test public void mM_sign_flip() { for (int[] xy : IIs) { int p=xy[0],q=xy[1]; long f=(long)org.apache.commons.math3.util.ArithmeticUtils.subAndCheck(p,q); long b; try{b=(long)org.apache.commons.math3.util.ArithmeticUtils.subAndCheck(q,p);}catch(Exception e){continue;} assertEquals(f,-b); } }
}