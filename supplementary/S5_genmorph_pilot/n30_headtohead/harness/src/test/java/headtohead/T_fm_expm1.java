...
/** Auto-generated head-to-head MR class for SUT fm_expm1 (org.apache.commons.math3.util.FastMath.expm1). Blocks: Lstar,Ole. */
public class T_fm_expm1 {
    ...
    @Test public void nN_zero() { assertEquals(0.0, org.apache.commons.math3.util.FastMath.expm1(0.0), 1e-15); }
    @Test public void nN_mono() { for (double x : DSE) { if (Math.abs(x)>20) continue; assertTrue(org.apache.commons.math3.util.FastMath.expm1(x) <= org.apache.commons.math3.util.FastMath.expm1(x+0.5)); } }
    @Test public void nN_consistency() { for (double x : DSE) { if (Math.abs(x)>20) continue; assertEquals(org.apache.commons.math3.util.FastMath.exp(x)-1.0, org.apache.commons.math3.util.FastMath.expm1(x), 1e-9*Math.abs(org.apache.commons.math3.util.FastMath.expm1(x))+1e-9); } }
    @Test public void bB_zero() { assertEquals(0.0, org.apache.commons.math3.util.FastMath.expm1(0.0), 1e-15); }
    @Test public void mM_additive() { for (double x : DSE) { if (Math.abs(x)>20) continue; assertEquals(org.apache.commons.math3.util.FastMath.exp(x)-1.0, org.apache.commons.math3.util.FastMath.expm1(x), 1e-9*Math.abs(org.apache.commons.math3.util.FastMath.expm1(x))+1e-9); } }
}