...
%%   (or: tectonic NOETHER_paper_arxiv.tex)

\PassOptionsToPackage{expansion=false}{microtype}
\documentclass[acmsmall, screen, nonacm]{acmart}

%% arXiv preprint: rights retained by author; no venue-specific header
...
%% TODO: Replace each <PLACEHOLDER> with the real author / affiliation / email
%% before uploading to arXiv. Add \author / \affiliation / \email blocks
%% per co-author if applicable.
\author{<AUTHOR_NAME>}
\affiliation{%
...
The supplementary archive accompanying this preprint contains four items, available alongside the source code at the project repository (see \texttt{README.md}). A SHA-256 content hash is computed over the concatenated tar-archive of the listed items and reported below for integrity verification.
...
Archive SHA-256: \texttt{dc54d8288205c98e1edd2a96e724cdc9261155990461b1c8efeee2e2db2e77b8}. Re-compute with \texttt{find . -type f -print0 | sort -z | xargs -0 cat | shasum -a 256} from inside the \texttt{supplementary/} directory.
